...
const Register: React.FC = () => {
  ...
  const handleGoogleRegister = async () => {
    setError('');
    try {
      // Simulate Google OAuth flow - in real app this would redirect to Google
      await register('user@gmail.com', 'google_oauth_token', 'Google User');
      navigate('/dashboard', { replace: true });
    } catch (err) {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-white border-2 border-gray-300 text-gray-700 py-4 px-4 rounded-lg font-semibold hover:bg-gray-50 hover:border-gray-400 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-105 flex items-center justify-center space-x-3"
          >
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg">
            <h4 className="text-sm font-semibold text-gray-900 mb-2 flex items-center">
              ...
              Quick & secure signup with Google
            </h4>
            <p className="text-xs text-gray-600">No password to remember • Instant access to all features</p>
          </div>
